...
const SCANew = () => {
  ...
  const [buyer, setBuyer] = useState({ Interc: [], Evolution: [] });
          ...
          <div className="col-lg-8 pt-4 pt-lg-0 content">
            ...
            {controlSubmit ? (
              ...
              <form onChange={handlerChange} onSubmit={handlerSubmit}>
                ...
                <hr />
                <h4>El paciente egreso de la institucion?</h4>
                
                <button onClick={() => thereIsEvolution(true)} type="button" class="btn btn-outline-success col-md-3 ">Si</button>
                <button onClick={() => thereIsEvolution(false)} type="button" class="btn btn-outline-danger col-md-3">No</button>
                
                
{evolution? <SCAEvolution/> : <div> <hr></hr> <button
                    type="submit"
                    className=" fromSCA btn btn-info btn-lg btn-block"
                  >
                    Carga Parcial
                  </button></div>}
